...
import { HELP, USER, HOST } from './constants';
import { renderFile, resolveOpen, manPage } from './fileSystem';
import { randomFortune, nowString } from './format';
...
export interface CmdCtx {
    ...
    setLines: (updater: (lines: import('./types').Line[]) => import('./types').Line[]) => void;
...
export function runCommand(raw: string, ctx: CmdCtx): void {
    const { fs, theme, data, history, setCwd, setLines, setTheme, setMatrixOn, pushCmd } = ctx;
