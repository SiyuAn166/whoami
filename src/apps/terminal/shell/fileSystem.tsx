...
export function renderFile(render: string | undefined, text: string | undefined, data: PortfolioData): ReactNode {
    switch (render) {
...
export function resolveOpen(fs: VDir, cwd: string[], arg: string): string | null {
    if (!arg) return null;
